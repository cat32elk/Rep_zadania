...
def get_price_to_usd(source, crypto_symbol):
    ...
    try:
        if source == "CoinGecko":
            ...
            # Получаем список монет для поиска ID
            ...
            return data['data'][crypto_symbol]['quote']['USD']['price'], None
            ...
            return float(data['data']['priceUsd']), None
            ...
            return data['quotes']['USD']['price'], None
